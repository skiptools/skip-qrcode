...
internal val logger: SkipLogger = SkipLogger(subsystem = "skiper.qrcode", category = "SkiperQRCode")

private typealias AppRootView = SkiperQRCodeRootView
private typealias AppDelegate = SkiperQRCodeAppDelegate
